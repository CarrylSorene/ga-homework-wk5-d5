...
y3.videos.create(title: 'Things I Almost Said on Twitter 2', category: 'Film & Animation', length: 6.52)
y4.videos.create(title: 'Easy Back To School Tips', category: 'How-to & Style', length: 3.52)
y5.videos.create(title: 'Time For Some Honesty!', category: 'Entertainment', length: 3.45)
